...
+ Analysis Workspace {#analysis-workspace}
   + Analysis Workspace-basisbeginselen {#analysis-workspace-basics}
   ...
   + Navigeren door werkruimteprojecten {#navigating-workspace-projects}
      + [Uw eerste project starten in Analysis Workspace](analysis-workspace/navigating-workspace-projects/starting-your-first-project-in-analysis-workspace.md)
   ...
   + Deelvensters {#using-panels} gebruiken
   ...
   + Vrije-vormtabellen maken {#building-freeform-tables}
      ...
      + [Totalen vrije-vormtabellen in Analysis Workspace](analysis-workspace/building-freeform-tables/freeform-table-totals-in-analysis-workspace.md)
   ...
   + Kalender- en datumbereik {#calendar-and-date-ranges}
      ...
      + [Datumbereik en -kalender gebruiken in Analysis Workspace](analysis-workspace/calendar-and-date-ranges/date-ranges-and-calendar-in-analysis-workspace.md)
   ...
   + Projecten cureren en delen {#curate-and-share-projects}
      ...
      + [Exporteren naar CSV vanuit Analysis Workspace](https://experienceleague.adobe.com/docs/analytics-learn/tutorials/exporting/from-the-ui/export-to-csv-from-analysis-workspace.html)
   ...
   + Attribution IQ {#attribution-iq}
      ...
      + [Attribution IQ gebruiken in tabellen voor vrije vorm](analysis-workspace/attribution-iq/using-attribution-iq-in-freeform-tables.md)
...
+ Implementatie {#implementation}
   ...
   + Via Experience Platform Launch {#via-adobe-launch}
      + [De Experience Cloud op websites implementeren met Experience Platform Launch](https://docs.adobe.com/content/help/en/experience-cloud/implementing-in-websites-with-launch/index.html)
   ...
   + JavaScript {#using-javascript} gebruiken
   ...
   + {#validating-and-troubleshooting} valideren en problemen oplossen
...
+ Verticaal specifieke {#vertical-specific}
   + Hoge Tech {#high-tech}
   ...
   + Reizen en gastvrijheid {#travel-and-hospitality}
   ...
   + Detailhandel {#retail}
      ...
      + [Basisvariabelen en -gebeurtenissen voor de detailhandel toevoegen aan opstartregel](vertical-specific/retail/adding-basic-retail-variables-and-events-to-launch-rules.md)
...
+ Analyse van mobiele apps {#mobile-app-analytics}
   + Implementatie {#implementation}
