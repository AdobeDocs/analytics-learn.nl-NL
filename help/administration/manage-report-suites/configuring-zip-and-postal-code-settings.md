...
# Instellingen voor [!UICONTROL Zip]- en postcode configureren in Adobe Analytics {#configuring-zip-and-postal-code-settings-in-adobe-analytics}
...
Voor meer informatie over [!UICONTROL zip code] montages, zie de [&#x200B; documentatie &#x200B;](https://experienceleague.adobe.com/docs/analytics/components/dimensions/zip-code.html?lang=nl-NL).
